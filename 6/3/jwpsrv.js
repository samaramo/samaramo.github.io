!function(a) {
    ...
    function d() {
        ...
        if (navigator.plugins && "object" == typeof navigator.plugins["Shockwave Flash"]) {
            if (b = navigator.plugins["Shockwave Flash"].description)
                return b
    ...
    var e = c(1)
      ...
      , k = function(a, b, c) {
        function d() {
            if ("" === pa.innerHTML || pa.className !== oa)
                na = 1;
            else {
        ...
        function k(a) {
            return Aa = x(a),
            [$(H, ja, 21), $(I, ba.getAutostart(), 11), $(J, fa, 21), $(Y, ga, 28), $(Z, ha, 28), $(U, ba.html5Mode(), 10), $(O, ca.bucket, 21), $(V, Aa, 101), $(L, w(a), 20), $(X, d(), 100)]
        }
        function m(a) {
        ...
        function q(a) {
            return function(b) {
                if (!za) {
                    var c = qa[a];
                    (a !== va || (b = b.metadata || b,
                    c && (b.width = b.width || c.width,
                    b.height = b.height || c.height,
                    b.duration = b.duration || c.duration),
                    !ba.html5Mode() || 100 !== b.duration && 0 !== b.duration || 0 !== b.width || 0 !== b.height)) && (qa[a] = b,
                    a === ua && (c || (xa = 0),
                    ya = ba.getPosition()),
                    qa[ua] && qa[va] && qa[wa] && (ra || (ra = !0,
                    B())))
                }
            }
        }
        ...
        function s(a) {
            return a = 0 | a,
            0 >= a ? 0 : 30 > a ? 1 : 60 > a ? 4 : 180 > a ? 8 : 300 > a ? 16 : 32
        }
        function t(a) {
            return a = 0 | a,
            0 >= a ? 0 : 15 > a ? 1 : 300 >= a ? 2 : 1200 >= a ? 3 : 4
        }
        function u() {
            ya = ba.getPosition(),
            sa = 0
        ...
        function y(a) {
            ...
            if (i && i.levels && i.levels.length) {
                var j = i.levels[0];
                if (j && "auto" === ("" + j.label).toLowerCase())
                    return f
            }
            var k, l = a.sources;
            if (l && l.length && (k = l[0].type,
            "aac" === k || "mp3" === k || "vorbis" === k))
                return g;
            var m = qa[va] || {}
              , n = 0 | m.width
              , o = 0 | m.height;
        ...
        function z(a) {
            a = a || ba.getPlaylistItem(),
            ga = A(12),
            da.calculate(),
            ta.track(ia, E, [$(W, l(), 22), $(R, ca.height, 22), $(Q, ca.width, 23)].concat(m(a)))
        }
        function A(a) {
        ...
        function B() {
            ...
            da.calculate(),
            ta.track(ia, F, [$(P, y(b), 21), $(S, t(a), 22)].concat(n(b, s(a))))
        }
        function C(a, b, c) {
            var d = b + .5 | 0;
            d > 0 && (da.calculate(),
            ta.track(ia, G, [$(M, d, 21), $(N, 0 | a, 22)].concat(n(ba.getPlaylistItem(), c))))
        }
        function D(a) {
            za = !!a.active
        }
        ...
        if (jwplayer.key) {
            var ka = new jwplayer.utils.key(jwplayer.key)
              , la = ka.edition();
            "invalid" !== la && (ia = ka.token()),
            "enterprise" === la ? ja = 6 : "invalid" === la ? ja = 4 : "ads" === la ? ja = 3 : "premium" === la ? ja = 2 : "pro" === la && (ja = 1)
        }
        ia || (ia = "_"),
        da.getCommonAdTrackingParameters = function() {
        ...
        da.calculate = function() {
            ca = function() {
                function a(a, b) {
                    return /\d+%/.test(a) && (a = Math.ceil(parseFloat(a) / 100 * b)),
                    b - a
                }
                var b = 1
                  , c = 2
                ...
                if (l) {
                    ...
                    j = Math.ceil(m.width),
                    k = Math.ceil(m.height)
                }
                var n = 0;
                return i.listbar && (n = i.listbar.size,
                "bottom" === i.listbar.position ? k = a(n, k) : j = a(n, j)),
                j = 0 | j,
                /\d+%/.test(i.width || j) && i.aspectratio ? {
                    bucket: e,
                    width: j,
                    height: k
                } : h > k ? {
        ...
        c.appendChild(pa);
        var qa, ra, sa, ta = new e(b,aa,"jwplayer6",ma), ua = "play", va = "meta", wa = "levels", xa = 0, ya = null, za = !1, Aa = null;
        ba.onReady(function() {
        ...
        ba.onPlay(q(ua)),
        ba.onMeta(q(va)),
        ba.onQualityLevels(q(wa)),
        ba.onCast(D),
        ba.onTime(function(a) {
            if (!za) {
                var b = a.position
                  , c = a.duration;
                if (b) {
...
, function(a, b, c) {
      ...
      , g = function(a, b, c, d, e) {
        ...
        if (!f) {
            if (h.iFrame = window.top !== window.self) {
                ...
                try {
                    h.pageURL = h.pageURL || window.top.location.href,
                    h.pageTitle = window.top.document.title
                } catch (i) {}
            }
            h.pageURL = h.pageURL || window.location.href,
            h.pageTitle = h.pageTitle || document.title
        }
        var j = jwplayer.utils.extend(this, h);
        if (!g) {
            var k = function() {
                for (j.pageLoaded = !0; j.queue.length; )
                    j.ping(j.queue.shift())
            };
    ...
    g.prototype.buildTrackingURL = function(a, b, c) {
        ...
        this.isiOSSDK && d.push(w(u, this.config.mobiledeviceid || "", 26), w(r, this.config.iossdkversion || "", 27), w(v, this.config.mobiledevicemodel || "", 28), w(s, this.config.bundleid || "", 29), w(t, this.config.applicationname || "", 30)),
        d.sort(function(a, b) {
            return a.priority - b.priority
        });
        for (var e = [], f = 0; d.length > f; f++)
            e.push(d[f].getKey() + "=" + encodeURIComponent(d[f].getValue()));
        var g = ["//", this.serverURL, "/", this.serverPath, e.join("&")];
        return "file:" === window.location.protocol && g.unshift("http:"),
        g.join("")
    }
    ,
    g.prototype.ping = function(a) {
        if (!this.pageLoaded)
            return void this.queue.push(a);
        var b = new Image;
        if (b.src = a,
        this.debug && e.isFunction(d.onping))
            try {
...
, function(a, b) {
    ...
    c.getAbsolutePath = function(a, b) {
        ...
        if (0 !== a.indexOf("/")) {
            var g = b.split("?")[0];
            g = g.substring(d.length + e.length + 1, g.lastIndexOf("/")),
            f = g.split("/").concat(f)
        }
        for (var h = [], i = 0; f.length > i; i++)
            f[i] && "." !== f[i] && (".." === f[i] ? h.pop() : h.push(f[i]));
        return d + e + "/" + h.join("/")
    }
    ,
    ...
    c.forEach = function(a, b) {
        var c, d;
        for (c in a)
            e(a.hasOwnProperty) ? a.hasOwnProperty(c) && (d = a[c],
            b(c, d)) : (d = a[c],
            b(c, d))
    }
    ;
...
, function(a, b) {
    var c = function(a, b, c) {
        b === !0 || b === !1 ? b = b ? 1 : 0 : (null === b || void 0 === b) && (b = ""),
        this.key = a,
        this.value = b,
        this.priority = c
    };
...
, function(a, b, c) {
    ...
    function g(a) {
        ...
        if (a.playlist) {
            if (!l(a.playlist)) {
                for (var c = [], d = 0; a.playlist.length > d; d++)
                    c[d] = h(a.playlist[d]);
                a.playlist = c
            }
        } else {
    ...
    function h(a) {
        ...
        for (var d = [], e = 0; c.sources.length > e; e++)
            d[e] = i(c.sources[e]);
        c.sources = d;
        var f = [];
        for (c.tracks = a && n(a.tracks) ? a.tracks : [],
        e = 0; c.tracks.length > e; e++)
            f[e] = j(c.tracks[e]);
        if (c.captions && !n(a.tracks)) {
            for (var g = 0; c.captions.length > g; g++)
                f.push(c.captions[g]);
            delete c.captions
        }
        return c.tracks = f,
    ...
    var m = jwplayer.utils.extend
      ...
      , q = function(a) {
        ...
        this.getPlaylistItem = function(b) {
            ...
            return b = b || this.playlistIndex,
            this.getConfig().playlist[b] || null
        }
        ,
...
, function(a, b) {
    ...
    function d(a, b) {
        for (var d, e = a, f = b; null !== e.parentElement && "undefined" != typeof e.parentElement.tagName; )
            d = i(e.parentElement),
            f = c(f, d),
            e = e.parentElement;
    ...
    function e(a, b) {
        for (var c = a, d = b; null !== c && "undefined" != typeof c.tagName; )
            null !== c.offsetParent && c.offsetParent === c.parentElement.offsetParent ? (d.top += c.offsetTop - c.parentElement.offsetTop,
            d.left += c.offsetLeft - c.parentElement.offsetLeft) : (d.top += c.offsetTop,
            d.left += c.offsetLeft),
            null !== c.parentElement && "BODY" !== c.parentElement.tagName && (d.top -= "undefined" != typeof c.parentElement.scrollTop ? c.parentElement.scrollTop : 0,
            d.left -= "undefined" != typeof c.parentElement.scrollLeft ? c.parentElement.scrollLeft : 0),
            c = c.parentElement;
        return d
    }
    function f(a, b) {
    ...
    function i(a) {
        if (!a.getBoundingClientRect)
            throw new Error("Cannot get bounds: " + a);
        ...
        return "width"in b || (c.width = b.right - b.left),
        "height"in b || (c.height = b.bottom - b.top),
        c
    }
    function j(a) {
        ...
        c) {
            var f = this
              ...
              , i = function(a) {
                ...
                b && b.type && "jwpsrv_position_response" === b.type && f.player.getID() === b.playerId && (f.lastViewRect = b.rect,
                f.lastViewPos = b.coords,
                f.iframeDepth = b.iframeDepth)
            };
            window.addEventListener ? window.addEventListener("message", i) : window.attachEvent("onmessage", i),
            h(a, g);
    ...
    k.prototype.getPosition = function() {
        if (this.player.getFullscreen())
            return "0,0";
        if (this.isPolling)
            return this.lastViewPos ? this.lastViewPos.left + "," + this.lastViewPos.top : null;
    ...
    k.prototype.getViewablePercentage = function(a) {
        if (this.player.getFullscreen())
            return 1;
        if (this.isPolling)
            return this.lastViewRect ? Math.round(1e3 * (this.lastViewRect.width * this.lastViewRect.height / (a.width * a.height))) / 1e3 : null;
        var b = g(this.player);
    ...
    k.prototype.getIFrameDepth = function() {
        if (this.isPolling === !0)
            return this.iframeDepth ? this.iframeDepth : null;
        for (var a = j(this.player.getContainer()), b = 0; a !== window.top; )
            a = j(a.frameElement),
            b++;
        return b
    }
...
, function(a, b, c) {
    ...
    a.exports = function(a, b, c, h, i, j) {
        function k(b) {
            b > 4 || (z.adscheduleid && b > v.previousQuartile && (a.calculate(),
            l(b)),
            v.previousQuartile = b)
        }
        function l(a) {
        ...
        i.onAdImpression(function(b) {
            ...
            v.tagdomain = n(w.getAbsolutePath(b.tag)),
            v.adSystem = b.adsystem || v.adSystem,
            v.vastVersion = b.vastversion || v.vastVersion,
            v.podIndex = b.sequence || v.podIndex,
            v.podCount = b.podcount || v.podCount,
            a.calculate(),
            x.track(c, A, s())
        }),
        ...
        i.onAdTime(function(a) {
            ...
            v.duration && k((4 * v.position + .05) / v.duration | 0)
        }),
        ...
        i.onAdError(function(b) {
            ...
            t(b);
            var e = 1;
            "object" == typeof b && b && (void 0 !== b.code && (e = b.code),
            void 0 !== b.tag && (v.tagdomain = n(w.getAbsolutePath(b.tag)))),
            a.calculate();
